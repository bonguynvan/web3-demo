...
import { User, KeyRound, AlertTriangle, Database, Megaphone, Bell, ArrowRight, Lock, ExternalLink, Bot, ShieldAlert, Trophy, Wallet, BookOpen, Flame, Microscope, Calculator, Sparkles } from 'lucide-react'
        ...
        <div>
          ...
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            ...
            >
              ...
              <div className="min-w-0">
                <div className="text-sm font-medium text-text-primary">Funding & OI</div>
                <div className="text-[11px] text-text-muted truncate">Multi-market tape · HL</div>
              </div>
            </Link>
            <Link
              to="/attribution"
              className="flex items-center gap-2.5 px-3 py-2.5 rounded-md border border-border bg-panel/40 hover:bg-panel hover:border-accent/40 transition-colors"
            >
              <Microscope className="w-4 h-4 text-accent shrink-0" />
              <div className="min-w-0">
            ...
            >
              ...
              <div className="min-w-0">
                <div className="text-sm font-medium text-text-primary">Strategy assistant</div>
                <div className="text-[11px] text-text-muted truncate">Hypothesis → bot config · Pro</div>
              </div>
            </Link>
          </div>
        </div>
